...
int main(int argc, char * argv[]){
    ...
    TreeNode vvip_user = createTreeNode(SchedStrategyPFabric(SchedStrategyPFabric()));
    ...
    attachFlow("10.1.1.1, 10.1.4.2, 49153, 8080, UDP", vvip_user);
    attachFlow("10.1.2.1, 10.1.5.2, 49153, 8080, UDP", vip_user);
    attachFlow("10.1.1.1, 10.1.4.2, 49154, 8080, UDP", vvip_user);
    attachFlow("10.1.2.1, 10.1.5.2, 49154, 8080, UDP", vip_user);
    attachFlow("10.1.1.1, 10.1.4.2, 49155, 8080, UDP", vvip_user);
    attachFlow("10.1.2.1, 10.1.5.2, 49155, 8080, UDP", vip_user);
    attachFlow("10.1.4.2, 10.1.1.1, 8080, 49153, UDP", vvip_user);
    attachFlow("10.1.5.2, 10.1.2.1, 8080, 49153, UDP", vip_user);
    attachFlow("10.1.4.2, 10.1.1.1, 8080, 49154, UDP", vvip_user);
    attachFlow("10.1.5.2, 10.1.2.1, 8080, 49154, UDP", vip_user);
    attachFlow("10.1.4.2, 10.1.1.1, 8080, 49155, UDP", vvip_user);
    attachFlow("10.1.5.2, 10.1.2.1, 8080, 49155, UDP", vip_user);
